...
class _$DoctorImpl implements _Doctor {
  ...
  @override
  String toString() {
    return 'Doctor(id: $id, name: $name, specialization: $specialization, rating: $rating, experienceYears: $experienceYears, phoneNumber: $phoneNumber, imageUrl: $imageUrl, availableDays: $availableDays, timeSlots: $timeSlots, isActive: $isActive)';
  }
...
abstract class _Doctor implements Doctor {
  const factory _Doctor(
      ...
      required final List<String> availableDays,
      required final List<String> timeSlots,
      final bool isActive}) = _$DoctorImpl;
